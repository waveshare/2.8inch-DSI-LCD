...
#Move driver file
sudo cp WS_2_8inchDSI480x640_Touch.ko /lib/modules/$(uname -r)
sudo cp WS_2_8inchDSI480x640_Screen.ko /lib/modules/$(uname -r)
sudo cp WS_2_8inchDSI480x640_Touch.dtbo /boot/overlays
sudo cp WS_2_8inchDSI480x640_Screen.dtbo /boot/overlays
...
#Install driver
sudo depmod
sudo modprobe WS_2_8inchDSI480x640_Touch
sudo modprobe WS_2_8inchDSI480x640_Screen
...
Data_Insertion config.txt  "dtoverlay=WS_2_8inchDSI480x640_Screen"
#Data_Insertion config.txt  "# -------------touch---------------"
Data_Insertion config.txt  "dtparam=i2c_vc=on"
Data_Insertion config.txt  "dtoverlay=WS_2_8inchDSI480x640_Touch,invertedy,swappedxy"
